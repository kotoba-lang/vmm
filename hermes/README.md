...
| profile | description |
|---|---|
| `tee-guest-maint` | TEE guest maintenance bot: kotoba-lang/vmm TEE decision plane (TDX/SEV-SNP) + kotoba-lang/aiueos tee-guest-detect maturity and stability. Propose-only. |
